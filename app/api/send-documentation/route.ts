...
const PHP_API_URL = process.env.DOCUMENTATION_API_URL || 'http://localhost/send%20mail/api/send-documentation.php';
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Erreur envoi documentation:', error);
    return NextResponse.json(
