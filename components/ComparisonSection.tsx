          ...
          <div key={index} className="grid grid-cols-2 min-h-[56px]">
            ...
            <div className="bg-white p-3 md:p-4 border-r border-gray-200 flex items-center">
              <div className="flex items-center gap-3 w-full">
                ...
                <p className="text-black font-bold text-sm md:text-base leading-relaxed flex-1">{item.ourSystem}</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-3 md:p-4 flex items-center">
              <div className="flex items-center gap-3 w-full">
                ...
                <p className="text-gray-800 text-sm md:text-base leading-relaxed flex-1">{item.classicSystem}</p>
              </div>
            </div>
          </div>
        ))}
