  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[600px] md:min-h-[700px] overflow-hidden bg-[#0A0E1A]">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-4 md:px-10 lg:px-20 py-16 md:py-20 flex justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-center w-full max-w-5xl mt-8 md:mt-12">
            ...
            <div>
              ...
              {/* Badges pays : fond sombre, texte blanc, arrondis */}
              <div className="flex flex-wrap gap-3">
                {targetCountries.map((country, index) => (
                  <div
                    key={index}
                    className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 flex items-center gap-2"
                  >
            ...
            <div
              className="bg-white rounded-2xl p-6 md:p-8 relative z-20 shadow-xl border-2 border-[#F9A825]"
            ...
            >
              ...
              <div className="flex justify-center">
                <button className="bg-[#F9A825] text-black font-semibold py-3 px-8 rounded-lg text-base md:text-lg hover:bg-[#F57C00] transition-colors duration-200 shadow-lg">
                  Contactez l&apos;équipe →
                </button>
              </div>
            </div>
      ...
      <section className="w-full bg-white py-16 md:py-20">
        <div className="max-w-[1600px] mx-auto px-4 md:px-10 lg:px-20">
            ...
            <div className="flex flex-col gap-6 md:gap-8">
              {faqItems.slice(0, 4).map((item, i) => {
                ...
                return (
                  <div
                    key={index}
                    className={`relative overflow-visible bg-white rounded-xl border transition-all duration-300 cursor-pointer ${
                      openIndex === index
                  ...
                  >
                    ...
                    {openIndex === index && (
                      <div className="absolute top-full left-0 right-0 z-20 mt-0 rounded-b-xl border border-t-0 border-gray-200 bg-white p-5 md:p-6 shadow-lg max-h-[280px] overflow-y-auto">
          ...
          <div className="flex justify-center mt-12 md:mt-16">
            <div className="bg-[#FFF7ED] rounded-xl p-8 md:p-10 max-w-3xl w-full">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <button className="w-full sm:w-auto bg-[#F9A825] text-black font-semibold py-3 px-8 rounded-lg text-base md:text-lg hover:bg-[#F57C00] transition-colors duration-200">
                  Contactez l&apos;équipe →
                </button>
                <button className="w-full sm:w-auto bg-transparent border-2 border-black text-gray-900 font-semibold py-3 px-8 rounded-lg text-base md:text-lg hover:bg-black/5 transition-colors duration-200">
